class AddActiveColumnToModels < ActiveRecord::Migration
  def up
  	...
  	add_column :location_has_categories, :active, :boolean, :default => true, :null => false
  	add_column :products, :active, :boolean, :default => true, :null => false
  	add_column :product_has_categories, :active, :boolean, :default => true, :null => false
  ...
  def down
  	...
  	remove_column :location_has_categories, :active
  	remove_column :products, :active
  	remove_column :product_has_categories, :active
